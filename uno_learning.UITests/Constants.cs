namespace uno_learning.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.zeusinstitute.Calculator";
    public readonly static string AndroidAppName = "com.zeusinstitute.Calculator";
